...
class MFNET_3D(nn.Module):
    ...
    def __init__(self, num_classes, pretrained=False, **kwargs):
        ...
        if pretrained:
            ...
            pretrained_model=os.path.join(os.path.dirname(os.path.realpath(__file__)), 'pretrained/MFNet3D_UCF-101_Split-1_96.3.pth')
...
if __name__ == "__main__":
    ...
    # ---------
    net = MFNET_3D(num_classes=101, pretrained=True)
